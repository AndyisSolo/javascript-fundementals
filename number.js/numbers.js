...
let formatter2 = new Intl.NumberFormat('de-DE', { style: 'currrency', currency: 'Eur'})
console.log(`Euros: ${formatter2.format(monthlySalary)}`);

let formatter3= new Intl.NumberFormat('ja-JA', { style: 'currrency', currency: 'JPY'})
console.log(`Yen: ${formatter3.format(monthlySalary)}`)


let formatter4= new Intl.NumberFormat('zh-HK', { style: 'currrency', currency: 'HKD'})
